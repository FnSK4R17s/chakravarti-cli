...
| Cursor CLI | File-based auth | CLI + UI | Cursor coding assistant CLI integration |
...
- **Cursor CLI** - ✅ Now supported in current release ([#32](https://github.com/FnSK4R17s/chakravarti-cli/issues/32))
