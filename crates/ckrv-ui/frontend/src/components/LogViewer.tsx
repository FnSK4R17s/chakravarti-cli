                ...
                <div className="flex items-center gap-3">
                    ...
                    {errorCount > 0 && (
                        <Button
                            ...
                            className="h-7 text-xs bg-primary/20 text-primary border-primary hover:bg-primary hover:text-background"
                        >
...
const LogLine: React.FC<LogLineProps> = ({ log }) => {
    ...
    const getTypeStyle = (type: string) => {
        switch (type.toLowerCase()) {
            ...
            case 'success':
                return { color: 'text-success', icon: <CheckCircle2 size={12} /> };
            case 'warning':
                return { color: 'text-warning', icon: <AlertCircle size={12} /> };
            case 'step_start':
                return { color: 'text-info', icon: <ChevronRight size={12} /> };
            case 'step_end':
                return { color: 'text-primary', icon: <CheckCircle2 size={12} /> };
            default:
