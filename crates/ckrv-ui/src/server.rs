...
pub async fn start_server(port: u16) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    let app = Router::new()
        ...
        .route("/api/specs/create", axum::routing::post(crate::api::specs::create_spec))
        .route("/api/specs/{name}/validate", get(crate::api::specs::validate_spec))
        .route("/api/specs/{name}/design", axum::routing::post(crate::api::specs::generate_design))
        .route("/api/specs/{name}/tasks", axum::routing::post(crate::api::specs::generate_tasks))
        .route("/api/specs/{name}/clarifications", get(crate::api::specs::get_clarifications))
        .route("/api/specs/{name}/clarify", axum::routing::post(crate::api::specs::submit_clarifications))
